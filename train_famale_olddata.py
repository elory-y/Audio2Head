...
wandb.init(entity="suimang", project="key_point_stage1", name="olddata_2e-4")
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(audio2kp.state_dict(), os.path.join("/home/user/Database/audio_data_girl/ky_point_olddata", '2e-4_%s_%.5f.pth' % (epoch, test_loss/num)))
        scheduler.step()
...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_datapath", default=r"/home/user/Database/audio_data_girl/audio_train")
