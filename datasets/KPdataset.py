...
if __name__ == "__main__":
    ...
    dataset = KeyPoint_Data(root_dir="/home/caopu/workspace/Audio2Head/test_data", frames=128, model_path="./checkpoints/audio2head.pth.tar")
    data = DataLoader(dataset, batch_size=2,
                      shuffle=True, num_workers=0)

    for number, dic in enumerate(data):

        mp4_path, audio_feature, poses, pad, starframe = dic["mp4_path"], dic["audio_features"], dic["poses"], dic["pad"],dic["star_frame"]
        print(mp4_path)