...
def audio2head(audio_path, img_path, save_path):
    ...
    audio_feature = np.load("/home/caopu/workspace/Audio2Head/data/test/audio_features_id1_00001.npy")
    ...
    pos = np.load("/home/caopu/workspace/Audio2Head/data/test/pose_id1_00001.npy")
    ref_pose_rot = pos[:, :3]
    ref_pose_trans = pos[:, 3:]
...
if __name__ == '__main__':
    ...
    parser.add_argument("--audio_path", default=r"/home/caopu/workspace/Audio2Head/data/test/id1_00001.wav", help="audio file sampled as 16k hz")
